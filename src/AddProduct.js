...
class AddProduct extends React.Component{
    render(){
        return(
            <div>
                <Container>
                    <p className="display-4 pt-5 mt-5 pb-5">Add Product</p>
                    <Row>
                        <Col xl="6">
                            <Form>
                                <FormGroup>
                                ...
                                <FormGroup>
                                    <Label for="examplePassword"><b>Product Category</b></Label>
                                    <Input type="text" name="password" id="examplePassword" placeholder="Enter product category" />
                                </FormGroup>
                                <FormGroup>
                        ...
                        <Col xl="6">
                            <Form>
                                ...
                                <FormGroup>
                                    <Label for="examplePassword"><b>Date</b></Label>
                                    <Input type="date" name="password" id="examplePassword" placeholder="Enter date" />
                                </FormGroup>
                                <FormGroup>
